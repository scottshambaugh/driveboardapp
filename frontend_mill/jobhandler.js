...
jobhandler = {
  ...
  set: function (job, name, optimize) {
    ...
    if (
      ...
      html +=
        "bbox : x[" +
        this.bbox[0].toFixed(0) +
        ", " +
        this.bbox[3].toFixed(0) +
        "] y[" +
        this.bbox[1].toFixed(0) +
        ", " +
        this.bbox[4].toFixed(0) +
        "] z[" +
        this.bbox[2].toFixed(0) +
        ", " +
        this.bbox[5].toFixed(0) +
        "]<br>";
  ...
  add_passes: function () {
    $("#passes_status").append(
      '<tr class="nodrag"><th>T#</th><th>Tool \
