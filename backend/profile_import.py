...
argparser = argparse.ArgumentParser(
    description="time/profile job import.", prog="profile_import.py"
)
...
argparser.add_argument(
    "-f", "--fast", dest="fast", action="store_true", default=False, help="animate fast"
)
argparser.add_argument(
    "-n",
    "--nooptimize",
...
def main():
    ...
    if args.jobfile:
        ...
        job = jobimport.convert(
            job, tolerance=float(args.tolerance), optimize=not (args.nooptimize)
        )
