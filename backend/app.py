...
def main():
    ...
    argparser.add_argument(
        ...
        "--version",
        action="version",
        version="%(prog)s " + config.conf["version"],
        default=False,
        help="print version of this app",
    )
    argparser.add_argument(
        "-d",
        "--debug",
        ...
        action="store_true",
        default=False,
        help="print more verbose for debugging",
    )
    argparser.add_argument(
        "-n",
        "--nobrowser",
        ...
        action="store_true",
        default=False,
        help="do not launch interface in browser",
    )
    argparser.add_argument(
        "-c",
        "--cli",
        ...
        action="store_true",
        default=False,
        help="run without server GUI window",
    )
    argparser.add_argument(
        "-u",
        "--usbhack",
